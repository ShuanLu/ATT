...
def sort():
	...
	r = [] # 变成Restrictive的需求
	p = [] # 变成Permissive的需求
	with open(r'D:\Study Materials\Python\test\BSO\a.txt') as f1:
		for line in f1:
			if 'P' in line:
...
def addnet():
	...
	with open(r'D:\Study Materials\Python\test\BSO\r.txt', 'w') as f2:
		with open(r'D:\Study Materials\Python\test\BSO\p.txt', 'w') as f3:
...
def addprefix():
	...
	with open(r'D:\Study Materials\Python\test\BSO\result.txt', 'w') as result:
		result_r = []
		result_p = []
		with open(r'D:\Study Materials\Python\test\BSO\r.txt') as f2:
			with open(r'D:\Study Materials\Python\test\BSO\p.txt') as f3:
...
def csdl():
	'''对比添加到csdl'''
	with open(r'D:\AT&T\BSO changes\Log\e9r-pf-1a-2019.11.26.txt',encoding='utf-8') as log:# 编码机制
		with open(r'D:\Study Materials\Python\test\BSO\csdl_permit_IP.txt', 'w') as csdl_net:
			with open(r'D:\Study Materials\Python\test\BSO\result.txt', 'r+') as result_add: # 读取指针重头开始r +写入
				permit_ip = []  # 全部对比net
